...
if __name__ == '__main__':
    project_prefix_path = "/Users/mrhmisu/.jnose_projects/commons-lang/src/main/java/"
    file_name = "/Users/mrhmisu/Repositories/test-smells/energy-profiler/smell-result/commons-lang/by-testsmell.csv"
    save_path = "/Users/mrhmisu/Repositories/test-smells/energy-profiler/smell-result/commons-lang/smell_testcases.json"
    smelly_test_save_path = "/Users/mrhmisu/Repositories/test-smells/energy-profiler/smell-result/commons-lang/smelly_testcases_run.txt"
    testclasss_map = process_report(file_name, project_prefix_path)
    test_list = make_smelly_test_list(testclasss_map)
    save_to_json(testclasss_map, save_path)
